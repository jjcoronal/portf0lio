...
> _I like to call myself an **urban innovator**, **designer** and **researcher** because of my **multidisciplinary approach** to tackling complex challenges in cities. With an MSc in Metropolitan Analysis, Design, and Engineering—a joint program by TU Delft and Wageningen University & Research—I integrate **theoretical inquiry**, **design experimentation**, and **real-world applications**, bridging abstract concepts with practical, impactful solutions._
...
> <img src="assets/img/unmutecommute/web_画板 1.png" alt="Alt Text" width="380" height="225">  <img src="assets/img/unmutecommute/Layout - MCAfinal.png" alt="Alt Text" width="300" height="200">
